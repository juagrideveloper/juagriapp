...
class OsConfirmUseCase(private val repository: OsConfirmRepository) {
    ...
    suspend fun updateOsConfirmStatus(ccode: String, status: Int, employee: JUEmployee, comments: String) =
        repository.updateOsConfirmStatus(ccode, status, employee, comments)
}
